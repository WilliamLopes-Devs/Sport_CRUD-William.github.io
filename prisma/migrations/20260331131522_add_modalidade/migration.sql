/*
  ...
  - Added the required column `modalidade` to the `alunos` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `alunos` DROP COLUMN `email`,
    ...
    ADD COLUMN `modalidade` VARCHAR(191) NOT NULL;
